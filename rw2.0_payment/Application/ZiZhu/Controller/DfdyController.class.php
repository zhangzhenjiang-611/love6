...
class DfdyController extends CommonController {
...
public function lis_get_card_no_cs(){
    // $card_no=I("post.card_no");
    $card_no ="1234";
    $row = M()->db(3,"DB_CONFIG3")->query("EXEC  usp_Search_report_zz  '".$card_no."'");
    // $nums = count($row);
    var_dump($row);
     echo M()->getLastSql();
   print_r($his_pay_list);exit;
    //HIS退款记录
    // var_dump($nums);exit;
    // if($nums=="1"){
    //     $res['success'] ="1";
