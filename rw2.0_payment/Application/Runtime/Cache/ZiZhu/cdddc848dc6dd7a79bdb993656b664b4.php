...
<link rel="stylesheet" type="text/css" href="/rw2.0_payment/Public/zizhu/css/base.css" />
<link rel="stylesheet" type="text/css" href="/rw2.0_payment/Public/zizhu/css/index.css" />
<script language="javascript" src="/rw2.0_payment/Public/zizhu/js/jquery-1.9.1.js" ></script> 
<script language="javascript" src="/rw2.0_payment/Public/zizhu/js/ServerClock.js" ></script>  
<script language="javascript" type="text/javascript" src="/rw2.0_payment/Public/layer/layer.js"></script>
<script language="javascript" type="text/javascript" src="/rw2.0_payment/Public/zizhu/js/my.js"></script>
...
<script language="javascript">
 window.onload = function () {
        ...
        $.ajax({
            url:"/rw2.0_payment/index.php/ZiZhu/Index/fakaji", 
            type:'post',
            dataType:'json',
            data:params,
...
$(function(){
    ...
    $("#jrgh_btn").mouseup(function(){
       ...
       window.location.href="/rw2.0_payment/index.php/ZiZhu/JinRiGuaHao/index/zzj_id/"+zzj_id;
    });
     //首页自助缴费按钮点击事件
    $("#jiaofei_btn").mouseup(function(){
          var zzj_id = $("#zzj_id").val();
          window.location.href="/rw2.0_payment/index.php/ZiZhu/JiaoFei/index/zzj_id/"+zzj_id;
    })

    //预约取号功能模块跳转方法
    $("#yyqh_btn").mouseup(function(){
         var zzj_id = $("#zzj_id").val();
        window.location.href="/rw2.0_payment/index.php/ZiZhu/YuYueQuHao/index/zzj_id/"+zzj_id;
    });

    //预约挂号功能模块跳转方法
    $("#yygh_btn").mouseup(function(){
        var zzj_id = $("#zzj_id").val();
        window.location.href="/rw2.0_payment/index.php/ZiZhu/YuYueGuaHao/index/zzj_id/"+zzj_id;
    });
    //化验单打印
    $("#huayan").mouseup(function(){
        var zzj_id = $("#zzj_id").val();                
        window.location.href="/rw2.0_payment/index.php/ZiZhu/HuaYan/index/zzj_id/"+zzj_id;
    });

    // 病历底方打印
    $("#dfdy").mouseup(function(){
        var zzj_id = $("#zzj_id").val();                
         window.location.href="/rw2.0_payment/index.php/ZiZhu/Dfdy/index/zzj_id/"+zzj_id;
    });
    ...
    $("#chaxun_btn").mouseup(function(){
        window.location.href="/rw2.0_payment/index.php/Chaxun/Index";
    });

   
    //缴费凭条功能模块跳转方法
    $("#ptbd_btn").mouseup(function(){
        window.location.href="/rw2.0_payment/index.php/ZiZhu/JiaoFeiPingTiao";
    });
      //首页点击退卡
