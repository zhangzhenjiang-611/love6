...
public function index(){
	 $soap = new \SoapClient('http://localhost:81/KWSService.asmx');
    	$s = "<zzxt><transcode>101</transcode><table><cardno>123</cardno><cardtype>1</cardtype><czyh></czyh></table></zzxt>";
    	$row = $soap->CallService("$s");
