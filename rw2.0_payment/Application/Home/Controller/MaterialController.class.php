...
// 数据库连接结束
  ...
  $pagesize='5';
  // 查询总记录条数
  // echo "call web.DHCViewSelfServiceInterface_GetTarItem('".$name."')";
 $return = odbc_exec($conn,"call web.DHCViewSelfServiceInterface_GetTarItem('".$name."','N')");
 $num=0;
while(odbc_fetch_row($return)) {
  ...
  // $changjia =odbc_result($return, 6);
  $changjia =odbc_result($return, 8);
