...
class SoapDiscovery {
	...
	public function getWSDL() {
		...
		$serviceWSDL = '<service name="'.$this->service_name."\">\n<documentation />\n<port name=\"".$this->service_name.'Port" binding="tns:'.$this->service_name."Binding\"><soap:address location=\"http://".$_SERVER['SERVER_NAME'].':'.$_SERVER['SERVER_PORT']."/rwzb_pay_old/soap/Service.php"."\" />\n</port>\n</service>\n";
		$messageWSDL = '';
