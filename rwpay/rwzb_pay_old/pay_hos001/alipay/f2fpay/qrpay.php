...
if (!empty($_POST['out_trade_no'])&& trim($_POST['out_trade_no'])!=""){
	...
	//echo $url;
	$time = time();
	$filename = "/home/www/alipay/ermweima/".$time.'.png'; 
	// 纠错级别：L、M、Q、H  
	$errorCorrectionLevel = 'L';  
	// 点的大小：1到10  
	$matrixPointSize = 4;
	if(!is_file("/home/www/alipay/ermweima/".$time.".png")){
		QRcode::png($url, $filename, $errorCorrectionLevel, $matrixPointSize, 2); 
	}
	echo "<img src='/ermweima/".$time.".png' />";
...
<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4 onload="test()">
	<div id="main">
		<div id="head">
