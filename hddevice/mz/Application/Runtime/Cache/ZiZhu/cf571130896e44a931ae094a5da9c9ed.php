 ...
 <div class="main_body">
    ...
    <div class="main_yuyue">
        ...
        <div class="bank_guahao mtnum2" style="display:none">
            ...
            <p>请将 <strong>银联</strong>/VISA<b>标识在上朝外</b>插入银行卡</p>
        </div>
...
function writeLog(logtxt,logtype){
    ...
    $.ajax({
            url:"/hddevice/mz/index.php/ZiZhu/Buhao/writeLogs", 
            type:'post',
            dataType:'json',
            data:params,
            success:function(data){}
...
function pay_record(dept_code,dept_name,doctor_code,doctor_name,card_type,business_type,pat_card_no,healthcare_card_no,id_card_no,pat_id,pat_name,pat_sex,charge_total,cash,zhzf,tczf,trading_state,healthcare_card_trade_state,his_state,bank_card_id,reg_info,trade_no,zzj_id,stream_no,tk_status){
        ...
        //alert("开始记录交易数据");
        $.ajax({
            url:"/hddevice/mz/index.php/ZiZhu/Buhao/witeJyRecordToDataBase", 
            type:'post',
            dataType:'json',
            data:params,
            success:function(data){
...
switch(op_now){
    case "ic_get_pat_info":
        ...
        var index_load = "";
        $.ajax({
            url:"/hddevice/mz/index.php/ZiZhu/Buhao/getPatInfo", 
            type:'post',
            dataType:'json',
            data:params,
            beforeSend:function(){
                 ...
                 if(data['patInfo']['result']['execute_flag']==0){
                   ...
                   // $("#times").val(data['chufang']['datarow'][0]['attr']['times']);
                    ...
                    $("#mobile").val(data['patInfo']['datarow']['mobile']);
                     ...
                     if(data['buhao']['result']['execute_flag']==0){
                         $("#jz_name").text($("#pat_name").val());
                            var html="";
                            var yuyue_list= data['buhao']["datarow"];
                        ...
                        /*alert(data['buhao']['result']['execute_message']);
                    alert($("#message").val());
                    a+=$("#message").val()+"<br/>";
                    a+=data['buhao']['result']['execute_message'];*/
                     $(".yuyue_record .tips").html(data['buhao']['result']['execute_message']);
                 }
                   ...
                   // $("#op_now").val("chose_business_type");
                    $(".mtnum2").hide();
                    $(".yuyue_record").show();
                   $(".yuyue_record .tips").html(data['patInfo']['result']['execute_message']);
        ...
        setTimeout(function(){
            ...
            if(flag==0){
              ...
              // alert(patinfo);
                setTimeout(function(){
                    if(patinfo!=""){
                        var params = {"input_xml":patinfo,"op_code":$("#op_code").val(),"zzj_id":$("#zzj_id").val()}; 
                        $.ajax({
                            url:"/hddevice/mz/index.php/ZiZhu/Buhao/YbXmlParse", 
                            type:'post',
                            dataType:'json',
                            data:params,
                            success:function(data){
                               // alert(data['result']['execute_flag']);
                                  if(data['result']['execute_flag']==0){
                                    ...
                                    /*alert(data['yb_input_data']['patient_id']);
                                    alert(data['yb_input_data']['code']);
                                    alert(data['yb_input_data']['card_code']);*/
                                    //alert(data['yb_input_data']['response_type']);
                                    ...
                                    if(data['buhao']['result']['execute_flag']==0){
                                     ...
                                     //  alert(yuyue_list[0]["unit_sn"]);
                                        ...
                                        $(".chufang_list").html(html);
                                        $("#response_type").val(data['buhao']['datarow'][0]['response_type']);
  ...
  $("#business_type").val("补挂号费");
    ...
    //alert($("#card_code").val());
     switch($("#card_code").val()){
        ...
        $.ajax({
                    url:"/hddevice/mz/index.php/ZiZhu/Buhao/quhao_huajia", 
                    type:'post',
                    dataType:'json',
                    data:params,
...
/*        alert(record_sn_se);
        ...
        setTimeout(function(){
                                ...
                                var params = {"input_xml":patinfo,"op_code":$("#op_code").val()}; 
                                    //讲划价信息传递到后台解析
                                    $.ajax({
                                        url:"/hddevice/mz/index.php/ZiZhu/Buhao/YbHalcParseGhao", 
                                        type:'post',
                                        dataType:'json',
                                        data:params,
                                        success:function(data){
...
$("#pay_zhifubao_quhao").on("click",function(){
    ...
    var index_load = "";
    $.ajax({
        url:"/hddevice/mz/index.php/ZiZhu/Buhao/getAliPayCode", 
        type:'post',
        dataType:'json',
        data:params,
        beforeSend:function(){
...
function getResult(out_trade_no,s1){
    ...
    $.ajax({
        url:"/hddevice/mz/index.php/ZiZhu/Buhao/ajaxGetPayStatus", 
        type:'post',
        dataType:'json',
        data:params,
        success:function(data){
  ...
  //  alert(card_code);
    ...
    //alert(111);
       switch(card_code){
            ...
            $.ajax({
                url:"/hddevice/mz/index.php/ZiZhu/Buhao/yyt_qh_save", 
                type:'post',
                dataType:'json',
                data:params,
                success:function(data){
            ...
            var int_xml_param = $("#record_sn").val()+"&"+$("#pay_seq").val()+"&"+$("#response_type").val()+"&"+$("#pat_code").val()+"&"+$("#card_code").val()+"&"+$("#card_no").val()+"&"+$("#charge_total").val()+"&"+$("#cash").val()+"&"+$("#zhzf").val()+"&"+$("#tczf").val()+"&"+record_id+"&"+$("#trade_no").val()+"&"+$("#stream_no").val()+"&"+$("#zzj_id").val()+"&"+cheque_type+"&"+bk_card_no+"&"+gh_flag;
                ...
                setTimeout(function(){
                   ...
                   // alert(patinfo);
                        ...
                        var mx="";
                        $.ajax({
                            url:"/hddevice/mz/index.php/ZiZhu/Buhao/YbSfConfirmXmlParseBhao", 
                            type:'post',
                            dataType:'json',
                            data:params,
                            success:function(data)
