...
var key_values="";
$(".phone .key li.num").on("mousedown",function(){
    key_values+=$(this).attr("param");
    $("#pat_phone").val(key_values);

})
$(".phone .key li.del").on("click",function(){
...
if(clicknum == 1){
   // alert(clicknum);
    ...
    if($("#business_type").val()=="预约取号"){
        ...
        $.ajax({
                    url:"/hddevice/mz/index.php/ZiZhu/QuHao/yuyue_huajia", 
                    type:'post',
                    dataType:'json',
                    data:params,
      ...
      case '20':
        ...
        setTimeout(function(){
                                ...
                                /*alert(patifo);*/
                                    //讲划价信息传递到后台解析
                                    $.ajax({
                                        url:"/hddevice/mz/index.php/ZiZhu/QuHao/YbHalcParseGhao", 
                                        type:'post',
                                        dataType:'json',
                                        data:params,
                                        success:function(data){
...
if($("#business_type").val()=="补挂号费"){
    ...
    //alert($("#card_code").val());
     switch($("#card_code").val()){
        ...
        var params = {"record_sn":record_sn,"card_code":$("#card_code").val(),"card_no":$("#card_no").val(),"patient_id":$("#pat_code").val(),"op_code":$("#op_code").val(),"zzj_id":$("#zzj_id").val(),"req_type":req_type};
        $.ajax({
                    url:"/hddevice/mz/index.php/ZiZhu/QuHao/quhao_huajia", 
                    type:'post',
                    dataType:'json',
                    data:params,
...
$("#xz_yu_quhao").on("click",function(){
    ...
    var params = {"patient_id":$("#pat_code").val(),"op_code":$("#op_code").val(),"zzj_id":$("#zzj_id").val(),"card_code":$("#card_code").val(),"card_no":$("#card_no").val(),};
     var index_load = "";
     $.ajax({
        url:"/hddevice/mz/index.php/ZiZhu/QuHao/patReservationRecord", 
            type:'post',
            dataType:'json',
            data:params,
            beforSend:function(){
                ...
                var a="";
                 ...
                 var myDate = new Date();
                    ...
                    if(nowtime > 1200 && yuyue_list[i]["ampm"] == 'a'){
                        ...
                        html+="<ul><li class='two'>"+y+"</li><li class='thr'>"+yuyue_list[i]["unit_name"]+"</li><li class='four'>"+yuyue_list[i]["charge"]+"</li><li class='six'>"+yuyue_list[i]["request_date"].replace("T"," ").substring(0,10) +"</li><li class='seven sure_quhao' record_sn="+yuyue_list[i]["register_sn"]+" req_type="+yuyue_list[i]["req_type"]+" unit_name="+yuyue_list[i]["unit_name"]+" doctor_name="+yuyue_list[i]["doctor_name"]+" unit_sn="+yuyue_list[i]["unit_sn"]+" ampm="+yuyue_list[i]["ampm"]+"  gh_sequence="+yuyue_list[i]["gh_sequence"]+">取号</li></ul>";
                    }
                 }
                $(".chufang_list").html(html);
                $("#jz_name").text(data['datarow']['0']['name']);
  ...
  //  alert($("#card_no").val());
   switch($("#card_code").val()){
    ...
    var params = {"patient_id":$("#pat_code").val(),"op_code":$("#op_code").val(),"zzj_id":$("#zzj_id").val(),"card_code":$("#card_code").val(),"card_no":$("#card_no").val()};
     var index_load = "";
     $.ajax({
        url:"/hddevice/mz/index.php/ZiZhu/QuHao/getPatReservationRecord", 
            type:'post',
            dataType:'json',
            data:params,
            beforSend:function(){
...
$("#xz_yu_guahao").on("click",function(){
     ...
     var index_load = "";
     $.ajax({
        url:"/hddevice/mz/index.php/ZiZhu/QuHao/CheckPatientCall", 
            type:'post',
            dataType:'json',
            data:params,
            beforSend:function(){
                ...
                if(data[0]['computed']=="0"){
                    ...
                    $("#confirm").css({"visibility":"visible"});
                     ...
                     writeLog("选择了预约挂号");
                      ...
                      var index_load = "";
                      $.ajax({
                         url:"/hddevice/mz/index.php/ZiZhu/QuHao/getTwoWeek", 
                                    type:'post',
                                    dataType:'json',
                                    //data:params,
                                    beforeSend:function(){
...
$(document).on("click",".chose_unit",function(){
   ...
   /*  $.ajax({
        url:"/hddevice/mz/index.php/ZiZhu/QuHao/gh_unlock", 
        type:'post',
        dataType:'json',
        data:params,
        success:function(data)
    ...
    //首先获取到被选中科室的科室编号
     ...
     var index_load = "";
        $.ajax({
            url:"/hddevice/mz/index.php/ZiZhu/QuHao/getSchedInfo", 
            type:'post',
            dataType:'json',
            data:params,
            beforeSend:function(){
   ...
   // alert($("#card_code").val());
    switch($("#card_code").val()){
      ...
      // alert(kaid);
            ...
            var index_load = "";
            $.ajax({
                    url:"/hddevice/mz/index.php/ZiZhu/QuHao/getGhPatInfo", 
                    type:'post',
                    dataType:'json',
                    data:params,
                    beforeSend:function(){
            ...
            if(flag==0){
                ...
                setTimeout(function(){
                    if(patinfo!=""){
                        ...
                        $.ajax({
                            url:"/hddevice/mz/index.php/ZiZhu/QuHao/YbXmlParseGhao", 
                            type:'post',
                            dataType:'json',
                            data:params,
                            beforeSend:function(){
...
$("#pay_zhifubao_quhao").on("click",function(){
    ...
    var index_load = "";
    $.ajax({
        url:"/hddevice/mz/index.php/ZiZhu/QuHao/getAliPayCode", 
        type:'post',
        dataType:'json',
        data:params,
        beforeSend:function(){
   ...
   //alert($("#op_now").val());
    ...
    switch(op_now){
        ...
        case "pat_phone":
           ...
           $.ajax({
                url:"/hddevice/mz/index.php/ZiZhu/QuHao/checkPhone",
                type:'post',
                dataType:'json',
                data:params,
                success:function(data){
       ...
       // alert(22);
        $.ajax({
            url:"/hddevice/mz/index.php/ZiZhu/QuHao/getPatInfo", 
            type:'post',
            dataType:'json',
            data:params,
            beforeSend:function(){
            ...
            if(flag==0){
                ...
                setTimeout(function(){
                    if(patinfo!=""){
                        var params = {"input_xml":patinfo,"op_code":$("#op_code").val()}; 
                        $.ajax({
                            url:"/hddevice/mz/index.php/ZiZhu/QuHao/YbXmlParse", 
                            type:'post',
                            dataType:'json',
                            data:params,
                            success:function(data){
...
function writeLog(logtxt,logtype){
    ...
    $.ajax({
            url:"/hddevice/mz/index.php/ZiZhu/QuHao/writeLogs", 
            type:'post',
            dataType:'json',
            data:params,
            success:function(data){}
...
function getResult(out_trade_no,s1){
    ...
    $.ajax({
        url:"/hddevice/mz/index.php/ZiZhu/QuHao/ajaxGetPayStatus", 
        type:'post',
        dataType:'json',
        data:params,
        success:function(data){
...
function Tcash(cash){
  ...
  if($("#business_type").val()=="预约挂号"){
       ...
       var params= {"req_type":$("#req_type").val(),"card_code":$("#card_code").val(),"card_no":$("#card_no").val(),"patient_id":$("#pat_code").val(),"record_sn":$("#record_sn").val(),"response_type":$("#response_type").val(),"charge_total":$("#charge_total").val(),"zhzf":$("#zhzf").val(),"tczf":$("#tczf").val(),"pay_charge_total":$("#cash").val(),"pay_seq":$("#pay_seq").val(),"trade_no":$("#trade_no").val(),"stream_no":$("#stream_no").val(),"op_code":$("#op_code").val(),"zzj_id":$("#zzj_id").val(),"pay_type":$("#pay_type").val(),"bk_card_no":$("#idCard").val(),"name":$("#pat_name").val(),"total_fee":$("#total_fee").val(),"social_no":$("#social_no").val(),"mobile":$("#mobile").val()};
        ...
        $.ajax({
            url:"/hddevice/mz/index.php/ZiZhu/QuHao/yyt_gh_save", 
                type:'post',
                dataType:'json',
                data:params,
        success:function(data){
...
xml version='1.0' encoding='utf-8'?>" + "<print_info width='300' height='500'>";
                ...
                s1 += "<tr font='黑体' size='10' x='20' y='" + (pos += 20) + "' >预约就诊时间:"+$("#date").val()+$("#ampm").val()+data['datarow']['gh_sequence']+"号</tr>";
...
xml version='1.0' encoding='utf-8'?>" + "<print_info width='300' height='500'>";
  ...
  if($("#business_type").val()=="预约取号"){
    ...
    switch(card_code){
            case '21'://就诊卡
            var index_load="";
            var params = {"req_type":$("#req_type").val(),"card_code":$("#card_code").val(),"card_no":$("#card_no").val(),"patient_id":$("#pat_code").val(),"record_sn":$("#record_sn").val(),"response_type":$("#response_type").val(),"charge_total":$("#charge_total").val(),"zhzf":$("#zhzf").val(),"tczf":$("#tczf").val(),"pay_charge_total":$("#cash").val(),"pay_seq":$("#pay_seq").val(),"trade_no":$("#trade_no").val(),"stream_no":$("#stream_no").val(),"op_code":$("#op_code").val(),"zzj_id":$("#zzj_id").val(),"pay_type":$("#pay_type").val(),"bk_card_no":$("#idCard").val(),"unit_sn":$("#unit_sn").val(),"ampm":$("#ampm").val()};
            $.ajax({
                url:"/hddevice/mz/index.php/ZiZhu/QuHao/yyt_qh_save1", 
                type:'post',
                dataType:'json',
                data:params,
                success:function(data){
           ...
           // alert($("#cash").val());
            ...
            var int_xml_param = $("#record_sn").val()+"&"+$("#pay_seq").val()+"&"+$("#response_type").val()+"&"+$("#pat_code").val()+"&"+$("#card_code").val()+"&"+$("#card_no").val()+"&"+$("#charge_total").val()+"&"+$("#cash").val()+"&"+$("#zhzf").val()+"&"+$("#tczf").val()+"&"+record_id+"&"+$("#trade_no").val()+"&"+$("#stream_no").val()+"&"+$("#zzj_id").val()+"&"+cheque_type+"&"+bk_card_no+"&"+gh_flag;
                ...
                setTimeout(function(){
                   ...
                   // alert(patinfo);
                        //alert("开始解析");
                        var params = {"input_xml":patinfo,"op_code":$("#op_code").val(),"pay_type":$("#pay_type").val(),"unit_sn":$("#unit_sn").val(),"ampm":$("#ampm").val(),"patient_id":$("#pat_code").val()}; 
                        var pt="";
                        var mx="";
                        $.ajax({
                            url:"/hddevice/mz/index.php/ZiZhu/QuHao/YbSfConfirmXmlParseGhao", 
                            type:'post',
                            dataType:'json',
                            data:params,
                            success:function(data)
...
if($("#business_type").val()=="补挂号费"){
    //alert(111);
       switch(card_code){
            ...
            $.ajax({
                url:"/hddevice/mz/index.php/ZiZhu/QuHao/yyt_qh_save", 
                type:'post',
                dataType:'json',
                data:params,
                success:function(data){
            ...
            var int_xml_param = $("#record_sn").val()+"&"+$("#pay_seq").val()+"&"+$("#response_type").val()+"&"+$("#pat_code").val()+"&"+$("#card_code").val()+"&"+$("#card_no").val()+"&"+$("#charge_total").val()+"&"+$("#cash").val()+"&"+$("#zhzf").val()+"&"+$("#tczf").val()+"&"+record_id+"&"+$("#trade_no").val()+"&"+$("#stream_no").val()+"&"+$("#zzj_id").val()+"&"+cheque_type+"&"+bk_card_no+"&"+gh_flag;
                ...
                setTimeout(function(){
                   ...
                   // alert(patinfo);
                        ...
                        var mx="";
                        $.ajax({
                            url:"/hddevice/mz/index.php/ZiZhu/QuHao/YbSfConfirmXmlParseBhao", 
                            type:'post',
                            dataType:'json',
                            data:params,
                            success:function(data)
...
function pay_record(dept_code,dept_name,doctor_code,doctor_name,card_type,business_type,pat_card_no,healthcare_card_no,id_card_no,pat_id,pat_name,pat_sex,charge_total,cash,zhzf,tczf,trading_state,healthcare_card_trade_state,his_state,bank_card_id,reg_info,trade_no,zzj_id,stream_no,tk_status){
        ...
        //alert("开始记录交易数据");
        $.ajax({
            url:"/hddevice/mz/index.php/ZiZhu/QuHao/witeJyRecordToDataBase", 
            type:'post',
            dataType:'json',
            data:params,
            success:function(data){
